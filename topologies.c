...
// insert_link_between_node(R0_re, R2_re, "eth0/4", "eth0/5", 1);

// node_set_loopback_address(R0_re, "127.1.1.0");
// node_set_interface_ip_address(R0_re, "eth0/0", "40.1.1.1",24);
...
// return topo;
 ...
 graph_t *topo = create_new_graph("Hello World Generic Graph");
    ...
    node_set_interface_ip_address(R0_re, "eth0/4", "40.1.1.1", 24);
